...
class Movie(models.Model):
    ...
    world_premire = models.DateField('Примьера в мире', default=date.today)
    budget = models.PositiveIntegerField('Бюджет', default=0, help_text='указывать сумму в долларах')
    fees_in_usa = models.PositiveIntegerField('Сборы США', default=0, help_text='указывать сумму в долларах')
...
class Review(models.Model):
    ...
    parents = models.ForeignKey('self', verbose_name='Родитель', on_delete=models.SET_NULL,blank=True,null=True,related_name='reviews')
